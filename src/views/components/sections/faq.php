        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="space-y-6" id="faq-container">
                <?php foreach ($faq_items as $index => $item): ?>
                    <div class="faq-item bg-neutral-50 rounded-2xl border border-neutral-200 overflow-hidden">
                        <div class="faq-question flex items-center justify-between p-6 cursor-pointer hover:bg-neutral-100 transition-colors">
                            ...
                            <svg class="faq-toggle w-6 h-6 text-neutral-600 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </div>
                        <div class="faq-answer p-6 pt-0 hidden text-neutral-600">
                            <?= $item['answer'] ?>
                        </div>
                    </div>
                <?php endforeach; ?>
